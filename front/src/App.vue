...
import { BookOutline as BookIcon, CropOutline as CropIcon, HomeOutline as HomeIcon, ConstructOutline as ConstructIcon, TrainOutline as TrainIcon, ChatbubbleOutline as ChatIcon } from '@vicons/ionicons5'
...
<template>
    <n-message-provider>
        <n-layout has-sider class="layout-container">
            <n-layout-sider bordered collapse-mode="width" :collapsed-width="64" :width="210" show-trigger
                @collapse="handleCollapse" class="aside">
